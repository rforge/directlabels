...
\item You should use the most recent version of R (cran.r-project.org)
...
1   Rural Male 66.0 70-74     0   0.5  30
2 Rural Female 54.3 70-74     0   0.5  30
3   Urban Male 71.1 70-74     0   0.5  30
4 Urban Female 50.0 70-74     0   0.5  30
\end{Soutput}
...
\item Then you can look at the interactive help pages
  ...
  \item Deepayan Sarkar (2008) Lattice: Multivariate Data Visualization
    with R, Springer.
  \item \url{http://directlabels.r-forge.r-project.org}
}
